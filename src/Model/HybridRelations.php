...
use Hobord\MongoDb\Relations\BelongsTo;
use Hobord\MongoDb\Relations\BelongsToMany;
use Hobord\MongoDb\Relations\HasMany;
use Hobord\MongoDb\Relations\HasOne;
use Hobord\MongoDb\Relations\MorphTo;
...
trait HybridRelations
{
    ...
    public function hasOne($related, $foreignKey = null, $localKey = null)
    {
        ...
        if (! is_subclass_of($related, 'Hobord\MongoDb\Model\Model')) {
